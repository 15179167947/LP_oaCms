...
public class UserController {
    ...
    public DataGridView loadAllUser(UserVo userVo) {
        ...
        queryWrapper.eq(StringUtils.isNoneBlank(userVo.getLoginname()), "loginname", userVo.getLoginname()).or()
                .eq(StringUtils.isNoneBlank(userVo.getName()), "name", userVo.getName());
        queryWrapper.eq(StringUtils.isNoneBlank(userVo.getAddress()), "address", userVo.getAddress());
        queryWrapper.eq("type", Constast.USER_TYPE_NORMAL);//查询系统中的用户
    ...
    public DataGridView initRoleByUserId(Integer id) {
       ...
       for (Map<String,Object> m1:listMaps){
           boolean LAY_CHECKED=false;
           Integer roleId= (Integer) m1.get("id");
           ...
           m1.put("LAY_CHECKED",LAY_CHECKED);
       }
