...
public class CacheAspect {
    ...
    //声明切面表达式
    private static final String POINTCUT_DEPT_UPDATE = "execution(* " +
            "com.sxt.sys.service.impl.DeptServiceImpl.updateById(..))";
    private static final String POINTCUT_DEPT_GET = "execution" +
            "(* com.sxt.sys.service.impl.DeptServiceImpl.getOne(..))";
    private static final String POINTCUT_DEPT_DELETE = "execution" +
            "(* com.sxt.sys.service.impl.DeptServiceImpl.removeById(..))";
    ...
    public Object cacheDeptGet(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        if (res1 != null) {
            ...
            CACHE_CONTAINER.put(CACHE_DEPT_PROFIX + dept2.getId(), dept2);
            return dept2;
        }
    }
